...
def _get_base_shape_features(
    density: jnp.ndarray, roles: jnp.ndarray, shapes: RigidBody, env_params
) -> jnp.ndarray:
...
def add_circle_features(
    base_features: jnp.ndarray, shapes: RigidBody, env_params, static_env_params
):
    return jnp.concatenate(
        [
            base_features,
...
def add_polygon_features(
    base_features: jnp.ndarray, shapes: RigidBody, env_param, static_env_params
):
    vertices = jnp.where(
