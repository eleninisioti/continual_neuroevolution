...
def main():
    ...
    config = OmegaConf.create({
        ...
        "continual": True,
        "load_from_checkpoint": "eleni/Kinetix-experiments/Kinetix-SymbolicEntity-MultiDiscrete-PPO-1B-2048_h1_thrust_over_ball_continual_True-529392377-0B-checkpoint:v0",
