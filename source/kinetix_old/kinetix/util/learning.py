...
def evaluate_rnn(  # from jaxued
    ...
    def step(carry, _):
        ...
        hstate, pi, _, _ = train_state.apply_fn(train_state.params, hstate, x)  # Ignore value and dormant_counts in eval
...
def sample_trajectories_rnn(
    ...
    def sample_step(carry, _):
        ...
        hstate, pi, value, _ = train_state.apply_fn(train_state.params, hstate, x)  # Ignore dormant_counts
    ...
    _, _, last_value, _ = train_state.apply_fn(train_state.params, hstate, x)  # Ignore dormant_counts
...
def update_actor_critic_rnn(
    ...
    def update_epoch(carry, _):
        def update_minibatch(train_state, minibatch):
            ...
            def loss_fn(params):
                _, pi, values_pred, _ = train_state.apply_fn(params, init_hstate, (obs, last_dones))  # Ignore dormant_counts
