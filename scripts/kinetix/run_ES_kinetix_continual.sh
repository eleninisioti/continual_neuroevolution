...
# Continual OpenES training on 20 medium Kinetix tasks (h0-h19)
# ES distribution (mean + optimizer state) carries over between tasks – no reset.
# Each task gets --generations_per_task generations (default 200).
#
# Usage:
#   ./run_ES_kinetix_continual.sh                          # Run on GPU 0
#   ./run_ES_kinetix_continual.sh --cuda 3                 # Run on GPU 3
#   ./run_ES_kinetix_continual.sh --generations_per_task 100
#   ./run_ES_kinetix_continual.sh --num_trials 5
#   ./run_ES_kinetix_continual.sh --no_wandb
...
LEARNING_RATE=0.01
SEED=0
WANDB_PROJECT="Kinetix-continual-es"
NO_WANDB=""
EVAL_REPS=10
EVOLVE_REPS=1
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--cuda GPU] [--num_trials N] [--popsize N] [--generations_per_task N] [--sigma F] [--learning_rate F] [--seed S] [--eval_reps N] [--evolve_reps N] [--no_wandb]"
            exit 1
            ;;
    esac
done
...
echo "========================================"
echo "Kinetix OpenES Continual Training"
echo "========================================"
echo "GPU: $GPU"
...
# Build command
CMD="python experiments/es_continual.py"
CMD="$CMD --gpu $GPU"
...
echo ""
echo "========================================"
echo "All OpenES continual training completed!"
echo "========================================"
