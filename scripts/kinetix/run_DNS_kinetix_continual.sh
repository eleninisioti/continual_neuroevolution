...
# Continual DNS (Dominated Novelty Search) training on 20 medium Kinetix tasks (h0-h19)
# Population carries over between tasks – no reset.
# Each task gets --generations_per_task generations (default 200).
#
# Usage:
#   ./run_DNS_kinetix_continual.sh                          # Run on GPU 0
#   ./run_DNS_kinetix_continual.sh --cuda 3                 # Run on GPU 3
#   ./run_DNS_kinetix_continual.sh --generations_per_task 100
#   ./run_DNS_kinetix_continual.sh --num_trials 5
#   ./run_DNS_kinetix_continual.sh --no_wandb
...
NUM_EVALS=3
SEED=0
WANDB_PROJECT="Kinetix-continual-dns"
NO_WANDB=""
EVAL_BATCH_SIZE=128
EPISODE_LENGTH=1000
LOG_INTERVAL=10
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--cuda GPU] [--num_trials N] [--popsize N] [--batch_size N] [--generations_per_task N] [--iso_sigma F] [--line_sigma F] [--k K] [--num_evals N] [--seed S] [--no_wandb]"
            exit 1
            ;;
    esac
done
...
echo "========================================"
echo "Kinetix DNS Continual Training"
echo "========================================"
echo "GPU: $GPU"
...
# Build command
CMD="python experiments/dns_continual.py"
CMD="$CMD --gpu $GPU"
...
echo ""
echo "Starting continual DNS training..."
echo "Command: $CMD"
echo ""
...
echo ""
echo "========================================"
echo "All DNS continual training completed!"
echo "========================================"
