#!/bin/bash
# Run OpenES Go1 leg damage continual training - 10 trials
# Runs trials sequentially on a single GPU
#
# Usage: ./run_ES_quadruped_continual.sh [GPU_ID]
...
echo "=============================================="
echo "OpenES Go1 Leg Damage Continual Training"
echo "=============================================="
echo "GPU: $GPU_ID"
...
for TRIAL in $(seq 1 $NUM_TRIALS); do
    ...
    RUN_NAME="es_${ENV}_continual_legdamage_trial${TRIAL}"
    PROJECT_DIR="${BASE_DIR}/es_${ENV}_continual_legdamage"
    ...
    python source/mujoco/train_ES_quadruped_continual.py \
        --env $ENV \
        --num_tasks $NUM_TASKS \
