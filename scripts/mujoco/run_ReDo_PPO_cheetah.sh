#!/bin/bash
# Run non-continual ReDo-PPO on CheetahRun for all 3 friction values
# Usage: ./run_ReDo_PPO_cheetah.sh [GPU_ID] [NUM_TRIALS]
...
ENV="CheetahRun"
OUTPUT_BASE="projects/mujoco/redo_ppo_${ENV}"

echo "=========================================="
echo "ReDo-PPO Non-Continual - CheetahRun Friction"
echo "=========================================="
echo "GPU: $GPU_ID"
...
echo ""
echo "=========================================="
echo "All ReDo-PPO training complete!"
echo "=========================================="
